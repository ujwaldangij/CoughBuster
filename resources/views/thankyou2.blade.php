...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/thankyou.css') }}" media="screen">
            ...
            <form action="#" method="get" class="u-border-1 u-border-grey-30 u-expanded-width-xs u-search u-search-left u-white u-search-1">
                <button class="u-search-button" type="submit">
                    <span class="u-search-icon u-spacing-10">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="svg-dbb6" x="0px" y="0px" viewBox="0 0 56.966 56.966" style="enable-background:new 0 0 56.966 56.966;" xml:space="preserve" class="u-svg-content">
        ...
        <div class="custom-expanded u-align-center u-container-style u-group u-radius u-shape-round u-white u-group-1">
            <div class="u-container-layout u-container-layout-1">
                ...
                <span class="infinite u-file-icon u-icon u-icon-circle u-palette-1-base u-icon-1" data-animation-name="shake" data-animation-duration="2000" data-animation-delay="1500" data-animation-direction="">
                    <img src="{{ asset('images/148808.png') }}" alt="">
                </span>
                <section>
                    <div id="head" class="container" >
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-12 text-center" style="margin-top: 20px;">
                                ...
                                <a href="" class="btn btn-success" style="font-size: 20px; padding: 10px 20px; background-color: green; color: white; text-decoration: none; display: inline-block; border-radius: 5px; border: 1px solid green !important;">Feedback</a>
                            </div>
                        </div>
                    </div>
                </section>
